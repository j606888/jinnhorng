...
const ProductCard = ({ title, description, image, url }) => {
  return (
    <div className="relative transition-transform duration-600 hover:-translate-y-4">
      ...
      <div className="flex flex-col items-center bg-white w-[300px] h-[390px] rounded-[10px] shadow-[0px_12px_25.6px_0px_rgba(0,0,0,0.06)] -mt-[196px] pt-[237px] text-center transition-shadow duration-600 hover:shadow-[0px_12px_25.6px_0px_rgba(0,0,0,0.12)]">
