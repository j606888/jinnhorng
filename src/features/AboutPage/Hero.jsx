...
const Hero = () => {
  return <section className="relative w-full h-[533px] bg-[url('/images/about/hero.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center z-1 overflow-hidden xl:aspect-[10/4] xl:h-auto ">
