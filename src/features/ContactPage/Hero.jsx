...
const Hero = () => {
  return <section className="relative w-full h-[300px] bg-[url('/images/contact/hero.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center z-1 overflow-hidden lg:h-[458px]">
