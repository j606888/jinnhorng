...
const AboutUs = () => {
  return (
    <section className="px-5 pt-10 pb-[120px] md:px-10 md:pb-[84px] lg:py-[96px] lg:flex lg:justify-center lg:items-center xl:py-20">
      <div className=" bg-[#F8F4EB] pt-[70px] text-center flex flex-col items-center relative md:pt-[60px] lg:pt-[58px] lg:pl-[91px] lg:pr-[42px] lg:w-[541px] lg:items-start lg:ml-[343px] lg:pb-[60px] lg:h-[633px] xl:w-[672px] xl:h-[785px] xl:pt-[104px] xl:pl-[173px] xl:pr-[91px] xl:ml-[409px]">
        <div className="mb-2">
        ...
        <div className="relative px-[14px] -mb-20 w-full max-w-100 md:px-0 md:-mb-12 lg:absolute lg:top-[44px] lg:left-[-343px] xl:top-[54px] xl:left-[-409px]">
          <div className="bg-[url('/images/homepage/syrup.jpg')] bg-cover bg-center bg-no-repeat w-full h-[476px] rounded-[12px] shadow-[7px_7px_36px_0px_rgba(0,0,0,0.16)] md:rounded-[6px] md:h-[557px] lg:w-[393px] lg:h-[548px] xl:w-[488px] xl:h-[680px]"></div>
        </div>
