  ...
  return (
    <section className="py-15 bg-[#F7F3F2] relative overflow-hidden">
      <div className="mb-14 px-5 flex flex-col items-center">
        ...
        <h2 className="text-[#30241E] text-4xl font-bold tracking-[2.88px] leading-[1.5] mb-3 md:text-[40px] md:tracking-[3.2px]">
      ...
      <div className="flex flex-col items-center px-[37.5px] gap-4 mb-14 z-2 relative md:flex-row ] ">
        ...
        <CircleButton
          ...
          onClick={prev}
        />
        <div className="hidden md:block md:overflow-hidden w-[520px] mx-auto md:rounded-[10px]">
          <div
