...
const Advantage = () => {
  return (
    <section className="bg-[#F7F3F2] -mt-[215px] relative overflow-hidden md:-mt-[204px] -z-10">
      <div className="h-[255px] md:h-[244px]"></div>
      <AnimateDiv className="flex flex-col gap-4 px-10 py-15 text-center md:px-25 max-w-[1080px] mx-auto xl:px-0">
