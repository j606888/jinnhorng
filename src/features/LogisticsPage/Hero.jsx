...
const Hero = () => {
  return <section className='relative w-full h-[360px] bg-[url("/images/logistics/hero.jpg")] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center lg:h-[458px]'>
