...
const Service = () => {
  return (
    <section className="relative overflow-x-clip">
      ...
      <AnimateDiv className="flex flex-col px-5 py-15 text-center md:px-10 lg:px-15 lg:py-20 lg:pb-15 max-w-[1080px] mx-auto xl:px-0">
        ...
        <div className="flex flex-col gap-5 md:flex-row">
          <div className="w-full h-[234px] rounded-[10px] overflow-hidden lg:h-[310px]">
            <img
              src="/images/logistics/truck-1.jpg"
              alt="truck-1"
          ...
          <div className="w-full h-[234px] rounded-[10px] overflow-hidden lg:h-[310px]">
            <img
              src="/images/logistics/truck-2.jpg"
              alt="truck-2"
              className="w-full h-full object-cover hover:scale-102 transition-all duration-300"
            />
          </div>
      ...
      <AnimateDiv className="flex flex-col px-5 md:px-10 lg:px-15 max-w-[1080px] mx-auto xl:px-0">
        ...
        <div className="flex flex-col gap-5 relative md:flex-row md:flex-wrap md:w-full z-10">
          {SERVICE_DATA.map((item) => (
            <div
              key={item.title}
              className="flex flex-col text-center px-7 py-10 rounded-[10px] bg-white shadow-[0px_2px_18px_0px_rgba(0,0,0,0.12)] items-center z-5 md:w-[calc(50%-10px)]"
            >
              <img
                src={item.image}
                alt={item.title}
                className="h-[100px] w-[133px] mb-3"
              />
              <h3 className="text-[18px] text-deep-brown font-medium tracking-[0.72px] mb-[9px]">
                {item.title}
              </h3>
              <p className="text-deep-brown text-sm font-normal tracking-[0.56px]">
                {item.description}
              </p>
            </div>
          ))}
          <img
            src="/images/logistics/box-1.png"
            alt="box-1"
            className="absolute w-[140px] h-[140px] md:w-[200px] md:h-[200px] -left-[50px] -bottom-[140px] md:-left-[40px] md:-bottom-[133px] xl:-left-[60px] xl:-bottom-[156px]"
          />
          <img
            src="/images/logistics/box-2.png"
            alt="box-1"
            className="absolute w-[180px] h-[180px] md:w-[250px] md:h-[250px] -right-[91px] -bottom-[111px] md:-right-[40px] md:-bottom-[128px] lg:-right-[60px] lg:-bottom-[117px]  xl:-bottom-[156px]"
          />
        </div>
      </AnimateDiv>
    </section>
