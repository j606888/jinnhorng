...
const Service = () => {
  return (
    <section>
      <div className="flex gap-2 px-10 py-4 text-sm tracking-[0.84px] font-normal text-[#30241E]">
        <span>首頁</span>
        <span>{">"}</span>
        <span className="font-bold">物流服務</span>
      </div>
      <div className="flex flex-col px-5 py-15 text-center">
        ...
        <div className="flex flex-col gap-5">
          <div className='w-full h-[234px] rounded-[10px] bg-[url("/images/logistics/truck-1.jpg")] bg-cover bg-center bg-no-repeat'></div>
          <div className='w-full h-[234px] rounded-[10px] bg-[url("/images/logistics/truck-2.jpg")] bg-cover bg-center bg-no-repeat'></div>
        </div>
      </div>
      <div className="flex flex-col px-5">
        ...
        <div className="flex flex-col gap-5 relative">
          {SERVICE_DATA.map((item) => (
            <div key={item.title} className="flex flex-col px-7 py-10 rounded-[10px] bg-white shadow-[0px_2px_18px_0px_rgba(0,0,0,0.12)] items-center z-5">
